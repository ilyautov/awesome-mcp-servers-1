...
- <img src="https://cdn.simpleicons.org/python/3776AB" height="14"/> [Consilium Principis](https://github.com/ilyautov/consilium-principis) - A board of AI advisor personas grounded in public-domain texts; every quote is verified word-for-word against its source by code, or the advisor abstains (fail-closed). Local stdio server.
